...
class DAO {
    ...
    private $DELETE = "DELETE  FROM telefon WHERE marka =?";
    private $MARKAPOSTOJI = "SELECT * FROM telefon WHERE marka=?";
	public function __construct()
	{
		$this->db = DB::createInstance();
	}
    public function delete($marka)
	{
    ...
    public function getMarka($marka)
	{
		...
		$statement = $this->db->prepare($this->MARKAPOSTOJI);
		$statement->bindValue(1, $marka);
